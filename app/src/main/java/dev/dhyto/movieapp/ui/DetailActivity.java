...
import dev.dhyto.movieapp.data.common.Constants;
...
public class DetailActivity extends AppCompatActivity {
    ...
    void displayTrailers(int movieId) {
        MovieService.getAPI().getTrailersByMovieId(movieId, "678ef42a1b584848591cbd02ac3899c3").enqueue(new Callback<TrailerResponse>() {
            @Override
